...
|LiveCodeBench V6 (코드)|66.7|DeepSeek-R1: 70.3|
|IFEVAL (지시 준수)|83.7|Phi 4: 84.9|
|KMMLU-REDUX (한국어)|72.7|DeepSeek-R1: 77.0|
|MMMLU (스페인어)|85.6|DeepSeek-R1: 88.2|
|도구 사용: BFCL-V3|63.9|Qwen-235B: 70.8|
...
- 🧠 추론 성능: 한국 수능 STEM 비전-언어 벤치마크에서 GPT-4.1 능가.
...
|:---:|:---:|:---:|
|KCSAT STEM 비전 QA|미지정|GPT-4.1 대비 능가 (비전 작업)|
